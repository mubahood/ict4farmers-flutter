...
class AppTheme {
  ...
  static CustomAppTheme customTheme = CustomAppTheme();
  ...
  static InputDecoration InputDecorationTheme1(
      {bool isDense: true, String label: "",String hintText: "", IconData iconData : Icons.edit }) {
    return InputDecoration(
      hintText: hintText.isEmpty?null:hintText,
      isDense: isDense,
      label: (label.isEmpty)? null:Text(label,style: TextStyle(fontWeight: FontWeight.w500,fontSize: 18, color: Colors.grey.shade400),),
      prefixIcon: Icon(iconData,color: Colors.grey.shade800,),
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    navigationRailTheme: NavigationRailThemeData(
        selectedIconTheme:
            IconThemeData(color: CustomTheme.primary, opacity: 1, size: 24),
        unselectedIconTheme:
            IconThemeData(color: Color(0xff495057), opacity: 1, size: 24),
        backgroundColor: Color(0xffffffff),
        elevation: 3,
        selectedLabelTextStyle: TextStyle(color: CustomTheme.primary),
    ...
    accentColor: CustomTheme.primary,
    ...
    sliderTheme: SliderThemeData(
      ...
      inactiveTrackColor: CustomTheme.primary.withAlpha(140),
  ...
  static ThemeData darkTheme = ThemeData(
      ...
      sliderTheme: SliderThemeData(
        activeTrackColor: CustomTheme.primary,
        inactiveTrackColor: CustomTheme.primary.withAlpha(100),
        trackShape: RoundedRectSliderTrackShape(),
        trackHeight: 4.0,
        thumbColor: CustomTheme.primary,
        thumbShape: RoundSliderThumbShape(enabledThumbRadius: 10.0),
  ...
  static NavigationBarTheme getNavigationThemeFromMode(int themeMode) {
    ...
    if (themeMode == themeLight) {
      ...
      navigationBarTheme.selectedItemColor = CustomTheme.primary;
